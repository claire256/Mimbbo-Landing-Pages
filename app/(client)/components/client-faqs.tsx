...
const faqs = [
  ...
  },
  {
    ...
    a: (
      <>
        Yes, a travel fee applies for at-home services, and 100% of it goes to
        your beauty pro. The fee is based on distance and shown before you book:
        <ul className="list-disc list-inside mt-2 space-y-1">
          <li>0–5 miles → $15</li>
          <li>6–10 miles → $25</li>
          <li>11–15 miles → $35</li>
          <li>16–20 miles → $45</li>
          <li>21+ miles → $60+</li>
        </ul>
      </>
    ),
    ...
    a: (
      <>
        ...
        <ol className="list-decimal list-inside mt-2 space-y-1">
          ...
          <li>
            Post your beauty need (what you’re looking for, date, budget, etc.).
          </li>
