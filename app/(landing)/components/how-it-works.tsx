...
const steps = [
  ...
  { step: "2.", title: "Activate Mimbbo Pay", description: " Get paid fast and securely for every gig you complete" },
  { step: "3.", title: "Start Taking Gigs", description: "Browse opportunities, apply for gigs, and start earning on your terms!" },
...
const HowItWorks = () => {
  return (
    <section className="" data-aos="fade-up">
      ...
      <div className="grid gap-4 mt-8 md:grid-cols-2 bg-slate-600 instructions section-padding">
